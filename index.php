	...
	<div id="wrap" data-ng-app="ela">
		...
		<div class="container" id="home">
			<div class="page-header">
				<h1>Welcome to <abbr title="Emerging Learders Academy">ELA</abbr> <small>from <a href="http://upstreamacademy.com">Upstream Academy</a></small></h1>
			</div>
				...
				<div class="row">
					...
					<div style="min-height: 600px" class="col-xs-12"><!-- eases the scroll jerk on small searches -->
						...
						<div class="text-center" data-ng-show="pages() !== 1"><!-- pager -->
							<span data-n8-pagination data-num-pages="pages()" data-current-page="page" data-max-show="5"></span>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- Begin Samples content -->
		<div class="container" id="samples">
			<div class="page-header">
				<h1>Project Samples</h1>
			</div>
			<img class="pull-right img-responsive col-sm-3 hidden-xs img-rounded" src="data/img/buiz0.jpg" alt="Business">
			<p class="lead">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ac eleifend nisl. Mauris vitae tincidunt turpis, quis facilisis orci. Maecenas elementum sapien vitae libero semper commodo. Quisque tincidunt, dui vitae laoreet sollicitudin, sem tellus interdum odio, eu ornare tellus tellus ac tortor. Nulla laoreet urna ligula, ut ultrices dui ultricies et. Proin in viverra tellus. Duis vel sem quis neque molestie vehicula id eu mauris. Mauris eleifend ut est at luctus. Sed nec ligula a lectus ultricies bibendum viverra vitae ante. Suspendisse fringilla turpis nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum nisl urna, non dictum dolor facilisis eu.
			</p>
			<p>
		...
		<div class="container" id="hints">
			...
			<img class="pull-right img-responsive col-sm-3 hidden-xs img-rounded" src="data/img/buiz4.jpg" alt="Business">
			<p class="lead">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ac eleifend nisl. Mauris vitae tincidunt turpis, quis facilisis orci. Maecenas elementum sapien vitae libero semper commodo. Quisque tincidunt, dui vitae laoreet sollicitudin, sem tellus interdum odio, eu ornare tellus tellus ac tortor. Nulla laoreet urna ligula, ut ultrices dui ultricies et. Proin in viverra tellus. Duis vel sem quis neque molestie vehicula id eu mauris. Mauris eleifend ut est at luctus. Sed nec ligula a lectus ultricies bibendum viverra vitae ante. Suspendisse fringilla turpis nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum nisl urna, non dictum dolor facilisis eu.
			</p>
			<p>
		...
		<div class="container" id="desc">
			<div class="page-header">
				<h1>Guide Description</h1>
			</div>
			<img class="pull-right img-responsive col-sm-3 hidden-xs img-rounded" src="data/img/buiz5.jpg" alt="Business">
			<p class="lead">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ac eleifend nisl. Mauris vitae tincidunt turpis, quis facilisis orci. Maecenas elementum sapien vitae libero semper commodo. Quisque tincidunt, dui vitae laoreet sollicitudin, sem tellus interdum odio, eu ornare tellus tellus ac tortor. Nulla laoreet urna ligula, ut ultrices dui ultricies et. Proin in viverra tellus. Duis vel sem quis neque molestie vehicula id eu mauris. Mauris eleifend ut est at luctus. Sed nec ligula a lectus ultricies bibendum viverra vitae ante. Suspendisse fringilla turpis nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum nisl urna, non dictum dolor facilisis eu.
			</p>
			<p>
			...
			<div class="container" id="login">
				...
				<div class="row">
						...
						<div class="well">
							<form role="form" action="index.php" method="post">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="inputUser" placeholder="Enter email" name="user">
								</div>
								<div class="form-group">
					...
					<div class="col-sm-3 col-sm-offset-1 hidden-xs">
						<img class="img-responsive img-rounded" src="data/img/buiz6.jpg" alt="Business">
					</div>
				</div>
			</div>
		<?php endif; ?>
